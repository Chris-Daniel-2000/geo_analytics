"""
Django settings for geo_analytics project.
...
# dotenv is used to load environment variables from a .env file, will be loaded in the server
...
ROOT_URLCONF = 'geo_analytics.urls'
...
WSGI_APPLICATION = 'geo_analytics.wsgi.application'
